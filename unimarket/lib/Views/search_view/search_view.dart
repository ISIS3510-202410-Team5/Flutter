...
class _SearchViewState extends State<SearchView> {
  ...
  void initState() {
    ...
    IconLabel.values[widget.categoryIndex] == IconLabel.noCategory
        ? print("nada")
        : {selectedIcon = IconLabel.values[widget.categoryIndex]};
  }
  ...
  filterTrendingProducts2() async {
    ...
    await Future.wait(trendingProductsList
        .map((product) => cacheImage(context, product.image))
        .toList());
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          backgroundColor: Provider.of<ThemeNotifier>(context)
              .getTheme()
              .cardColor, // Set background color to green
  ...
  requestFilteredProducts(ThemeNotifier notifier) async {
    ...
    List<ProductModel> listaProds =
        await _searcController.getFilteredProducts(selectedIcon!.label, used);

    await Future.wait(listaProds
        .map((product) => cacheImage(context, product.image))
        .toList());
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemCount:
                            trendsReady ? trendingProductsList.length : 5,
                        itemBuilder: (context, index) => trendsReady
                            ? Container(
                                width: 120,
                                child: Card(
                                  color: notifier.getTheme().cardColor,
                                  child: InkWell(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Text(
                                            "Price: ${trendingProductsList[index].price}",
                                            style: const TextStyle(
                                                fontSize: 10.0,
                                                fontWeight: FontWeight.bold,
                                                fontFamily: 'Roboto')),
                            ...
                            ? const Align(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Image(
                                      image: AssetImage(
                                          'assets/images/search_something.png'),
                                      height: 160,
                                      width: 150,
                                    ),
                                    SizedBox(
