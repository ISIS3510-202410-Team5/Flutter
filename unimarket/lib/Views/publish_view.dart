                  ...
                  Stack(
                    children: [
                      ...
                      Column(children: [
                        const Row(
                          children: [
                            ...
                            Text("Product Image", style: TextStyle(color: Colors.black, fontSize: 18.0, fontWeight: FontWeight.bold))
                          ],
                        ),

                        const Divider(height: 5, thickness:1.7, indent: 10, endIndent: 155, color: Colors.deepOrange,),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            CircleAvatar(
                              radius: 100,
                              backgroundImage: const NetworkImage("https://cdn4.iconfinder.com/data/icons/documents-36/25/add-picture-512.png"),
                        ...
                        const Row(
                          children: [
                            ...
                            Text("Product Name", style: TextStyle(color: Colors.black, fontSize: 18.0, fontWeight: FontWeight.bold))
                          ],
                        ),
                        ...
                        const Row(
                          children: [
                            ...
                            Text("Product Price", style: TextStyle(color: Colors.black, fontSize: 18.0, fontWeight: FontWeight.bold))
                          ],
                        ),

                        const Divider(height: 5, thickness:1.7, indent: 10, endIndent: 165, color: Colors.deepOrange,),
                        ...
                        const Row(
                          children: [
                            ...
                            Text("Product Description", style: TextStyle(color: Colors.black, fontSize: 18.0, fontWeight: FontWeight.bold))
                          ],
                        ),

                        const Divider(height: 5, thickness:1.7, indent: 10, endIndent: 110, color: Colors.deepOrange,),
                        ...
                        const SizedBox(height: 20,),
                         ...
                         Row(
                          children: [
                            ...
                            const Text("Product Category", style: TextStyle(color: Colors.black, fontSize: 18.0, fontWeight: FontWeight.bold),),
                        ...
                        const Divider(height: 0, thickness:1.7, indent: 10, endIndent: 130, color: Colors.deepOrange,),
                      ...
                      Positioned(
                        top:220,
                        left: 190,
                        child: IconButton(onPressed: (){showImagePickerOption(context);}, icon: const Icon(Icons.add_a_photo), iconSize: 30,)
                      ),
                    ],
                  )
                ],
